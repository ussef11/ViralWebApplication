const Callus = () => {
 ...
 <div class="bl_wrapper">
  <svg id="svg_tramp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
		...
		<text transform="matrix(1 0 0 1 354 346)" class="text_forgiveness">Error 404</text>
		<text transform="matrix(1 0 0 1 351 372)">
			
			<tspan x="0" y="31" class="text_forgiveness">  <a class="btn_home" href="/"> Go HOME </a></tspan>
		</text>
	</svg>
