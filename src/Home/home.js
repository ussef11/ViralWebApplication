...
const {Data:blog}  = usefetch("https://viral-web-application-pl3j-agyzf8hrl-ussef11.vercel.app/getallarticles")
...
<div className="item-2">
        <a href={`https://www.koora4lives.live/pages/${art.id_articles}`} className="card">
